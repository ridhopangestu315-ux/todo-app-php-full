...
foreach ($tasks as $task) {
    ...
    if (!$selesai) $tugas_belum_selesai++;
...
<body class="<?= (int)$settings['dark_mode'] ? 'mode-gelap' : '' ?>" data-halaman-aktif="<?= e($active_page) ?>">
  ...
  <div class="wadah-aplikasi">
    <aside class="menu-samping">
      ...
      <nav class="daftar-menu">
        <button class="tombol-menu <?= $active_page === 'dashboard' ? 'aktif' : '' ?>" type="button" data-halaman="dashboard">
          <span class="ikon-menu">
            <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="tombol-menu <?= $active_page === 'tugas' ? 'aktif' : '' ?>" type="button" data-halaman="tugas">
          <span class="ikon-menu">
            <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <button class="tombol-menu <?= $active_page === 'kalender' ? 'aktif' : '' ?>" type="button" data-halaman="kalender">
          <span class="ikon-menu">
            <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
        ...
        <button class="tombol-menu <?= $active_page === 'pengaturan' ? 'aktif' : '' ?>" type="button" data-halaman="pengaturan">
          <span class="ikon-menu">
            <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <nav class="bottom-navigation-mobile" aria-label="Navigasi mobile">
    <button class="tombol-nav-mobile <?= $active_page === 'dashboard' ? 'aktif' : '' ?>" type="button" data-halaman="dashboard">
      <span>
        <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
          <polyline points="9 22 9 12 15 12 15 22"/>
    ...
    <button class="tombol-nav-mobile <?= $active_page === 'tugas' ? 'aktif' : '' ?>" type="button" data-halaman="tugas">
      <span>
        <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
          <line x1="9" y1="9" x2="15" y2="9"/>
    ...
    <button class="tombol-nav-mobile <?= $active_page === 'kalender' ? 'aktif' : '' ?>" type="button" data-halaman="kalender">
      <span>
        <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
          <line x1="16" y1="2" x2="16" y2="6"/>
    ...
    <button class="tombol-nav-mobile <?= $active_page === 'pengaturan' ? 'aktif' : '' ?>" type="button" data-halaman="pengaturan">
      <span>
        <svg class="ikon-menu-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="12" cy="12" r="3"/>
          <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>
